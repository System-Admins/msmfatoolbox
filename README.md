...
1. To install the module and it dependencies, run the following in a PowerShell 7 session:
   ...
   ```powershell
   Install-Module -Name 'Microsoft.Entra', 'Microsoft.Graph.Grsoups', 'Microsoft.Graph.Users', 'Microsoft.Graph.Users.Actions', 'Microsoft.Graph.Identity.DirectoryManagement', 'Microsoft.Graph.Authentication' -Scope CurrentUser -Force;
